...
// Proxy PÚBLICO de foto de vistoria, usado no link de preenchimento
// (/vt/<token>). Só serve a foto se ela pertence à vistoria daquele token.
export async function GET(request: NextRequest) {
  ...
  const { data, error } = await supabase.rpc("fdl_anexo_vistoria_publico", {
    p_token: token,

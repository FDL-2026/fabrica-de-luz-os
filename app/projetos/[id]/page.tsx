                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <a
                      ...
                      className="inline-flex h-9 shrink-0 items-center justify-center rounded-full bg-[var(--fdl-lilac)] px-4 text-xs font-semibold text-[var(--fdl-purple-dark)] transition hover:bg-white"
                    >
                      Gerenciar
                    </a>
                  </div>
